...
examples= [
        ...
        },
        {
            ...
            "query": "SELECT Name of Monitoring Location, BOD_Max (mg/L) FROM ground_water_quality_data WHERE State_Name = 'State_X' ORDER BY BOD (mg/L) DESC;"
        }
    ]
